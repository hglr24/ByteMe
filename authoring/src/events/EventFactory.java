...
/**
 * This is a Utilities class that EventPane and AuthoringEvents use in order to display particular options and properties associated
 ...
 * controls to the user to input information necessary to instantiate different engine.external.events and engine.external.actions. One
 * issue I struggled a lot with was ensuring there wasn't duplicated code and that the controls displayed to the user would be able
 * to toggle according to their input. Since conditions and actions were supposed to be the most flexible point of our project, I created
 * this class to generalize the problem as much as possible so different areas of the project could reuse the methods to display whatever
 * would be needed for the user to be presented with all the options at their disposal.
 * @author Anna Darwish
 */
